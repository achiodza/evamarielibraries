    ...
    <div class="container-fluid py-4">
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Borrowed On</th>
      ...
      <script>
        document.addEventListener('DOMContentLoaded', async function() {
            ...
            try {
                const response = await fetch('https://admin.evamarielibraries.org/api/borrowedbooks?populate=*&sort[0]=createdAt:desc', {
                    headers: {
