        ...
        fetch('http://203.161.49.218:1337/api/borrowedbooks?populate=*', {
          ...
          .then(data => {
            ...
            requests.forEach(request => {
              ...
              const bookTitle = attributes.bookdetail?.title || 'N/A';
              ...
              const category = attributes.bookdetail?.genre || 'N/A';
              const availabilityStatus = attributes.bookdetail?.availability ? 'Yes' : 'No';
